...
| **Facade classes** | **26** from **11.0.0.1** onward; **14** in **8.0.0.1** |
...
- **11.0.0.1** and later (**17.0.0.1**, **21.0.0.1**, **24.0.0.1**, …) expose all **26** rows above. **8.0.0.1** exposes the rows marked **Yes** in the last column only.
