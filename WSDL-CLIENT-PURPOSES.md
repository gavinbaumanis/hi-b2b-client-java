...
| **Facade classes** | **26** in **`1.7.1.1`**; **14** in **`1.6.4.1`** |
...
| Purpose | WSDL service | What it does | Java facade | In **`1.6.4.1`** (14 facades) |
|---|---|---|---|:---:|
...
| **IHI - batch search** | `HI_ConsumerSearchIHIBatchAsync` | Submit/retrieve async batch IHI search | `ConsumerSearchIHIBatchAsyncClient` | **`1.7.1.1` only** |
| **IHI - create** | `HI_ConsumerCreateProvisionalIHI` | Create provisional IHI | `ConsumerCreateProvisionalIHIClient` | **`1.7.1.1` only** |
| **IHI - update** | `HI_ConsumerUpdateProvisionalIHI` | Update provisional IHI | `ConsumerUpdateProvisionalIHIClient` | **`1.7.1.1` only** |
| **IHI - merge** | `HI_ConsumerMergeProvisionalIHI` | Merge provisional IHIs | `ConsumerMergeProvisionalIHIClient` | **`1.7.1.1` only** |
| **IHI - resolve** | `HI_ConsumerResolveProvisionalIHI` | Resolve provisional IHI | `ConsumerResolveProvisionalIHIClient` | **`1.7.1.1` only** |
| **IHI - create** | `HI_ConsumerCreateUnverifiedIHI` | Create unverified IHI | `ConsumerCreateUnverifiedIHIClient` | **`1.7.1.1` only** |
| **IHI - create** | `HI_ConsumerCreateVerifiedIHI` | Create verified IHI | `ConsumerCreateVerifiedIHIClient` | **`1.7.1.1` only** |
| **IHI - update** | `HI_ConsumerUpdateIHI` | Update IHI details | `ConsumerUpdateIHIClient` | **`1.7.1.1` only** |
| **IHI - notify** | `HI_ConsumerNotifyDuplicateIHI` | Notify duplicate IHI | `ConsumerNotifyDuplicateIHIClient` | **`1.7.1.1` only** |
| **IHI - notify** | `HI_ConsumerNotifyReplicaIHI` | Notify replica IHI | `ConsumerNotifyReplicaIHIClient` | **`1.7.1.1` only** |
...
| **HPI-I - TDS search** | `HI_ProviderSearchTdsProviderIndividual` | Search TDS provider individual | `ProviderSearchTdsProviderIndividualClient` | **`1.7.1.1` only** |
| **HPI-I - TDS manage** | `HI_ProviderManageTdsProviderIndividual` | Manage TDS provider individual | `ProviderManageTdsProviderIndividualClient` | **`1.7.1.1` only** |
...
- **`1.7.1.1`** exposes all **26** rows above. **`1.6.4.1`** exposes the rows marked **Yes** in the last column only.
