...
= 1.7.1.1 =
======
- Maven **`au.gov.nehta:hi-b2b-client`** **1.7.1.1** (Java **11** / **Jakarta**, **26** facade clients, full MCA). Pair with **`hi-wsdl`** **1.7.1.1**.
...
- For in-repo `wsimport`, keep that particle order in licensed `SearchIHIMessages.xsd` (see `wsdls/README.md`). With `-Phi-wsdl-artifact`, use matching **`au.gov.nehta:hi-wsdl`** **1.7.1.1**.
