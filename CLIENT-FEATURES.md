...
**Audience:** integrators choosing APIs for **`11.0.0.1`** (**26** facade classes). Setup (Maven Central dependency, keystores, endpoints) is in **`README.md`**.

Smaller release line **`8.0.0.1`** exposes **14** standard HI B2B facades only - see **`README.md`** Versioning table before assuming a class exists in your version.
...
## Quick index - all facade classes (`11.0.0.1`)
